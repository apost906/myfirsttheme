<meta name="viewport" content="width-device-width, initial-width:0" />
...
<script type="text/javascript" src="<?php echo get_template_directory_uri() ?>/bootsrap/js/bootsrap.min.js"></script>
